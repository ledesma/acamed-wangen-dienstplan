...
const resources = {
  de: {
    translation: {
      ...
      addEmployee: 'Benutzer hinzufügen',
      editEmployee: 'Benutzer bearbeiten',
      actions: 'Aktionen',
      ...
      confirmDeleteEmployee: 'Sind Sie sicher, dass Sie diesen Benutzer löschen möchten?',
      ...
      employeeAdded: 'Benutzer hinzugefügt',
  ...
  en: {
    translation: {
      ...
      confirmDeleteEmployee: 'Are you sure you want to delete this user?',
